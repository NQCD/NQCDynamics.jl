...
n_states = 1# # number of electronic n_states
x = 0.0 # position of 1D particle
vinit = -0.1 # initial velocity
step = 0.01 # MD step
...
#solution = Dynamics.run_trajectory(z, (0.0, 2500), sim)

#a=plot(solution.t, [real(Dynamics.get_density_matrix(u)[1,1]) for u in solution.u], label="σ[1,1]")
