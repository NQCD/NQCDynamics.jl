...
sol1 = solve(prob1,Dynamics.IntegrationAlgorithms.MDEF_BAOAB();dt=1/10,save_noise=true)
...
sol2 = solve(prob2,Dynamics.IntegrationAlgorithms.MDEF_BAOAB();dt=1/10)
@test sol1[:] ≈ sol2[:]

disable_logging(Logging.Info)

dts = (1/2) .^ (8:-1:3)
res = analyticless_test_convergence(dts, prob1, Dynamics.IntegrationAlgorithms.MDEF_BAOAB(), (1/2)^12;
