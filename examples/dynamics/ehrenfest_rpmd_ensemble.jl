...
#model 1
@time solution1 = Ensembles.run_ensemble(sim1, timespan, selection1; trajectories=1e3,
...
@time solution3 = Ensembles.run_ensemble(sim3, timespan, selection3; trajectories=1e3,
...
#model 2
@time solution2 = Ensembles.run_ensemble(sim2, timespan, selection2; trajectories=1e3,
...
@time solution4 = Ensembles.run_ensemble(sim4, timespan, selection4; trajectories=1e3,
