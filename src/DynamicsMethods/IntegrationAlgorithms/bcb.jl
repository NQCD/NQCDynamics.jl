...
function OrdinaryDiffEq.OrdinaryDiffEqSymplecticRK.verify_f2(
    f,
    res,
    p,
    q,
...
function OrdinaryDiffEqCore.initialize!(integrator, integrator_cache::BCBCache)
    ...
    OrdinaryDiffEq.OrdinaryDiffEqSymplecticRK.verify_f2(
        integrator.f.f2,
        integrator.k[2].x[2],
        duprev,
        uprev,
...
@muladd function OrdinaryDiffEqCore.perform_step!(
    ...
    vprev, rprev, acceleration =
        OrdinaryDiffEq.OrdinaryDiffEqSymplecticRK.load_symp_state(integrator)
    ...
    OrdinaryDiffEq.OrdinaryDiffEqSymplecticRK.store_symp_state!(
        integrator,
        integrator_cache,
        acceleration,
        v,
