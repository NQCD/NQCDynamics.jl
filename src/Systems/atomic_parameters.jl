...
"""
    AtomicParameters(cell::Cell{T}, atom_types::Vector{Symbol}) where {T<:AbstractFloat}

Constructor for the parameters.

The user must provide the simulation cell and the list of elements in the system.
"""
function AtomicParameters(cell::Cell{T}, atom_types::Vector{Symbol}) where {T<:AbstractFloat}
